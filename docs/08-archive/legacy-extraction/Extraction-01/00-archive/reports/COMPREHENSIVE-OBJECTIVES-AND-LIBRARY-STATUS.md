...
| **Milkdown** | Markdown editor | module-based editor | 🟡 **MED** | Alternative editor |
...
| Library | Purpose | Value Proposition | Priority | Reason Not Yet Used |
|---------|---------|-------------------|----------|-------------------|
| **Obsidian-TextGenerator** | LLM in Obsidian | Obsidian module patterns | 🟡 **MED** | Phase 4 (module system) |
...
| **SilverBullet** | Markdown wiki | module system patterns | 🟢 **LOW** | Phase 4+ |
...
4. **Future Features:** 5 libraries are for advanced features (modules, mobile, etc.)
...
| **Milkdown** | module-based, flexible | Less popular | 🟢 Research |
