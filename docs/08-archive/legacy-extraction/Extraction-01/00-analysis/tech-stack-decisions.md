...
| **Markdown Parser** | remark + remark-parse | latest | Extensible, module-based markdown processing |
...
```json
{
  "devDependencies": {
    "@types/node": "^20.0.0",
    "@typescript-eslint/eslint-module": "^6.0.0",
    "@typescript-eslint/parser": "^6.0.0",
    "eslint": "^8.0.0",
    "eslint-config-prettier": "^9.0.0",
    "eslint-module-react": "^7.0.0",
    "eslint-module-react-hooks": "^4.0.0",
    "husky": "^8.0.0",
    "lint-staged": "^15.0.0",
    "prettier": "^3.0.0",
    "typescript": "^5.3.0"
...
```json
{
  ...
  "devDependencies": {
    ...
    "vite-module-electron": "^0.28.0",
    "vite-module-electron-renderer": "^0.14.0"
  }
}
```
...
module.exports = {
  ...
  extends: [
    'eslint:recommended',
    'module:@typescript-eslint/recommended',
    'module:react/recommended',
    'module:react-hooks/recommended',
    'prettier'
  ],
  rules: {
...
- **module System:** Extensible for SBF needs (frontmatter, entity linking)
...
- Port modules to Tiptap extensions
