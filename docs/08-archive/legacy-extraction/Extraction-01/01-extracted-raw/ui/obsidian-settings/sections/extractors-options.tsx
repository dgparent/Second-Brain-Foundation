...
export default function ExtractorsOptionsSetting(props: {
  ...
  const listOfOptions = useMemo(
    () => Object.keys(global.Module.defaultSettings.extractorsOptions),
    []
  );
          ...
          return (
            ...
            >
              <Input
                ...
                value={
                  "" +
                  global.Module.settings.extractorsOptions[
                    key as keyof typeof global.Module.settings.extractorsOptions
                  ]
                }
                setValue={async (val) => {
                  global.Module.settings.extractorsOptions[
