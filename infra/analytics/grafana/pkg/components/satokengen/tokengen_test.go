...
func TestApiKeyValidation(t *testing.T) {
	result := KeyGenResult{
		ClientSecret: "glsa_dummySecretForTestPurposesOnly12_12345678",
	...
	require.Equal(t, "dummySecretForTestPurposesOnly12", keyInfo.Secret)
	require.Equal(t, "12345678", keyInfo.Checksum)
